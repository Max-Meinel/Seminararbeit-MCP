...
Die Arbeit gliedert sich in fünf Kapitel. @grundlagen[Kapitel] legt die Grundlagen zu #acrpl("LLM"), autonomen Agenten und Werkzeugintegration. @mcp-kapitel[Kapitel] stellt das #acr("MCP") vor, beschreibt Architektur und Kernfunktionen und arbeitet die sicherheitsrelevanten Designentscheidungen heraus. @sicherheit[Kapitel] bildet den Kern der Arbeit: Es systematisiert Bedrohungsmodell und Angreifertypen, analysiert die vier Angriffsvektoren Indirect Prompt Injection, Tool Poisoning und bösartige Server, Manipulation der Werkzeugauswahl sowie Tool Chaining und Sandbox Escape und ordnet die verfügbaren Gegenmaßnahmen diesen Vektoren zu. @fazit[Kapitel] beantwortet die Forschungsfrage und gibt einen Ausblick auf offene Fragen der Protokollentwicklung. Den Ausgangspunkt bilden die Grundlagen zu Sprachmodellen und ihrer Werkzeugnutzung im folgenden Kapitel.
